...
First let's take a look at what our reference `Pocillopora_meandrina_HIv1.genes-validated.gff3.gff3` file looks like
...
Unfortunately, looking at our gff, it seems that `Pocillopora_meandrina_HIv1.genes-validated.gff3` is formatted more like this:
...
So we want to 
1) isolate mRNA regions in `Pocillopora_meandrina_HIv1.genes-validated.gff3`
