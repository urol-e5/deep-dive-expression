...
write.csv(edges_pval_0.05_unique, "../output/31-Ptuh-miRNA-mRNA-lncRNA-network/edges_miRNA_mRNA_lncRNA_network_p0.05_unique.csv", quote = FALSE)
write.csv(edges_pval_0.01_unique, "../output/31-Ptuh-miRNA-mRNA-lncRNA-network/edges_miRNA_mRNA_lncRNA_network_p0.01_unique.csv", quote = FALSE)
```
...
![](31-Ptuh-miRNA-lncRNA-network_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
