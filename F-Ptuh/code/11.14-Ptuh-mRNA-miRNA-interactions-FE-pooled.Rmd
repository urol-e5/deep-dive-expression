---
title: "11.14-Ptuh-mRNA-miRNA-interactions-FE-pooled"
...
This script will use topGO to analyze functional enrichment of miRNA targets for Ptuh, *pooling all target sites* (3UTR, 5UTR, and CDS)
...
Of the 16,807 putative miRNA targets predicted by miRanda, 9,484 have available annotations (56.4%)
...
Of the 902 putative 3UTR miRNA targets predicted by miRanda that are also have significantly correlated expression, 523 have available annotations (58.0%)
