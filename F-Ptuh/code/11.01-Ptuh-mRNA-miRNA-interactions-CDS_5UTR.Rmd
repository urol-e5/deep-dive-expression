...
-fi "../data/Pocillopora_meandrina_HIv1.assembly" \
...
../data/06-Ptuh-miRNA-mRNA-RNAhybrid/miRNA_mature-Ptuh.fasta \
...
wc -l ../output/07-Ptuh-miRNA-mRNA-miRanda/Ptuh-miRanda-3UTR-strict-parsed.txt

echo "number of putative interactions of at least 21 nucleotides"
awk -F'\t' '$7 >= 21' ../output/07-Ptuh-miRNA-mRNA-miRanda/Ptuh-miRanda-3UTR-strict-parsed.txt | wc -l

echo "number of putative interactions of at least 21 nucleotides, with at most 3 mismatches"
awk -F'\t' '$7 >= 21' ../output/07-Ptuh-miRNA-mRNA-miRanda/Ptuh-miRanda-3UTR-strict-parsed.txt | awk -F'\t' '$8 >= 85' | wc -l
```
