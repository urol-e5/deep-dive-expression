...
```{r}
miranda_Ptuh_names <- left_join(miranda_Ptuh, lncRNA_mapping_filt, by = c("lncRNA" = "lncRNA_coord")) %>%
...
```{r}
pcc_miranda_Ptuh <- left_join(miranda_Ptuh_names, pcc_results, by = c("miRNA", "lncRNA_id" = "lncRNA"))
