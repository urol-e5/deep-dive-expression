...
ggsave("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miRNA_number_of_targets.png", last_plot(), width = 12, height = 10, dpi = 300)
ggsave("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miRNA_number_of_targets.pdf", last_plot(), width = 12, height = 10, dpi = 300)
...
# Save as csv
#write.csv(pcc_results, "../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-PCC_miRNA_mRNA.csv")
```

This df is too large to push to github; save to personal computer and put on OSF. 
...
# Save as csv
write.csv(combined_data_pcc, "../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miranda_PCC_miRNA_mRNA.csv")
```

Read in data so that PCC does not have to be run again, as it is computationally intensive
```{r}
combined_data_pcc <- read.csv("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miranda_PCC_miRNA_mRNA.csv")
```
...
ggsave("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miRNA_positive_negative_correlations.png", last_plot(), width = 12, height = 10, dpi = 300)
ggsave("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miRNA_positive_negative_correlations.pdf", last_plot(), width = 12, height = 10, dpi = 300)
```
...
write.csv(pairs_of_interest_pcc, "../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miranda_PCC_sig_miRNA_mRNA.csv")
```

Read in data so that PCC does not have to be run again, as it is computationally intensive
```{r}
pairs_of_interest_pcc <- read.csv("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miranda_PCC_sig_miRNA_mRNA.csv")
```
...
#ggsave("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miRNA_significant_positive_negative_correlations.png", last_plot(), width = 12, height = 10, dpi = 300)
#ggsave("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-miRNA_significant_positive_negative_correlations.pdf", last_plot(), width = 12, height = 10, dpi = 300)
```
...
#ggsave("../output/11-Ptuh-mRNA-miRNA-interactions/Ptuh-significant_miRNA_mRNA_network.png", p, width = 12, height = 10, dpi = 300)
```
