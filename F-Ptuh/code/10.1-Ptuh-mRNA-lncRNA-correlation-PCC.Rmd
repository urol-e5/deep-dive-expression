...
nohup Rscript ../output/10.1-Ptuh-mRNA-lncRNA-correlation-PCC/run_mRNA_lncRNA_PCC.R > ../output/10.1-Ptuh-mRNA-lncRNA-correlation-PCC/run_mRNA_lncRNA_PCC_log.txt 2>&1 &
```

```{r, engine='bash' eval=FALSE}
nohup Rscript ../output/10.1-Ptuh-mRNA-lncRNA-correlation-PCC/run_mRNA_lncRNA_PCC_chunks.R > ../output/10.1-Ptuh-mRNA-lncRNA-correlation-PCC/run_mRNA_lncRNA_PCC_chunks_log.txt 2>&1 &
```
...
```{r}
pcc_results <- read.csv("../output/10.1-Ptuh-mRNA-lncRNA-correlation-PCC/Ptuh-PCC_mRNA_lncRNA.csv")
#read.csv("https://gannet.fish.washington.edu/kdurkin1/ravenbackups/deep-dive-expression/F-Ptuh/output/10.1-Ptuh-mRNA-lncRNA-correlation-PCC/Ptuh-PCC_mRNA_lncRNA.csv")
```
