...
This script will use topGO to analyze functional enrichment of miRNA targets for Ptuh in the CDS regions
...
Of the 9537 putative miRNA targets (CDS region) predicted by miRanda, 6325 have available annotations
...
Of the 499 putative CDS miRNA targets predicted by miRanda that are also have significantly correlated expression, only 337 have available annotations.
