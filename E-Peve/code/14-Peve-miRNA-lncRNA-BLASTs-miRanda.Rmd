...
LncRNAs were identified from Peve RNA-seq data in `deep-dive/E-Peve` -- see details there.
Fasta of Peve lncRNAs stored at `https://raw.githubusercontent.com/urol-e5/deep-dive/main/E-Peve/output/Peve_lncRNA.fasta`


```{r check-lncRNAs, engine='bash', eval=TRUE}
curl -L https://raw.githubusercontent.com/urol-e5/deep-dive/main/E-Peve/output/Peve_lncRNA.fasta -o ../output/14-Peve-miRNA-lncRNA-BLASTs-miRanda/Peve_lncRNA.fasta
...
This is a dramatically smaller number -- only 1 interaction was at least 21 nucleotides with <=3 mismatches
