...
``` r
# Read in counts data.
Peve_counts_lncRNA_OG <- read.table("../output/07-Peve-lncRNA-matrix/Peve-lncRNA-counts.txt", header=TRUE, skip=1) 
head(Peve_counts_lncRNA_OG)
```

          Geneid                         Chr   Start     End Strand Length
    1 lncRNA_001 Porites_evermani_scaffold_1  422642  423512      +    871
    2 lncRNA_002 Porites_evermani_scaffold_1 1084866 1089422      +   4557
    3 lncRNA_003 Porites_evermani_scaffold_1  372244  372449      +    206
    4 lncRNA_004 Porites_evermani_scaffold_1  683877  684280      +    404
    5 lncRNA_005 Porites_evermani_scaffold_1 1202043 1202328      +    286
    6 lncRNA_006 Porites_evermani_scaffold_1 1477780 1478077      +    298
      ...output.06.Peve.Hisat.RNA.POR.71.sorted.bam
    1                                           206
    2                                           334
    3                                             9
    4                                            18
    5                                             4
    6                                             0
      ...output.06.Peve.Hisat.RNA.POR.73.sorted.bam
    1                                           135
    2                                           112
    3                                             0
    4                                            16
    5                                             0
    6                                             0
      ...output.06.Peve.Hisat.RNA.POR.76.sorted.bam
    1                                           237
    2                                             0
    3                                            26
    4                                            23
    5                                            28
    6                                            40
      ...output.06.Peve.Hisat.RNA.POR.79.sorted.bam
    1                                            99
    2                                           147
    3                                             8
    4                                             2
    5                                             0
    6                                             0
      ...output.06.Peve.Hisat.RNA.POR.82.sorted.bam
    1                                           207
    2                                           431
    3                                            18
    4                                            24
...
colnames(Peve_counts_lncRNA) <- sub("...output.06.Peve.Hisat.RNA.", "", colnames(Peve_counts_lncRNA))
...
```
    ...
    lncRNA_001    206    135    237     99    207
    lncRNA_002    334    112      0    147    431
    lncRNA_003      9      0     26      8     18
    lncRNA_004     18     16     23      2     24
    lncRNA_005      4      0     28      0      3
    lncRNA_006      0      0     40      0      0
