---
title: "10.14-Peve-mRNA-miRNA-interactions-FE-pooled"
...
This script will use topGO to analyze functional enrichment of miRNA targets for Peve, *pooling all target sites* (3UTR, 5UTR, and CDS)
...
Of the 22,598 putative miRNA targets (pooled 3UTR, CDS, and 5UTR regions) predicted by miRanda, 13,453 have available annotations (59.5%)
...
Of the 1,267 putative miRNA targets predicted by miRanda that are also have significantly correlated expression, 802 have available annotations (63.2%).
