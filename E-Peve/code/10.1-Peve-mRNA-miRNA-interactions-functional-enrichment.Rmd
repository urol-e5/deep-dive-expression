...
This script will use topGO to analyze functional enrichment of miRNA targets for Peve. 
...
```{r}
data <- read.csv("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/Peve-miranda_PCC_miRNA_mRNA.csv")
head(data)
...
colnames(peve_gene2go) <- c("mRNA", "GO.ID")
```
...
# All genes 
all_genes <- as.character(peve_gene2go$mRNA)
...
```{r}
gene2go_topgo<-readMappings("../../data/Peve_gene2go.tab", IDsep=";", sep="\t")
```
...
# Join the datasets based on GO term
GO_MF_En_sig_gene <- peve_gene2go %>%
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_neg_corr_target_enrichment.pdf", plot, width = 20, height = 35, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_neg_corr_target_enrichment.png", plot, width = 20, height = 35, dpi = 300)
```
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_neg_corr_target_enrichment.pdf", plot, width = 20, height = 25, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_neg_corr_target_enrichment.png", plot, width = 20, height = 25, dpi = 300)
```
...
# Save as csv 
write.csv(test, "../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_pos_corr_target_enrichment.csv")
```
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_pos_corr_target_enrichment.pdf", plot, width = 20, height = 35, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_pos_corr_target_enrichment.png", plot, width = 20, height = 35, dpi = 300)
```
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_pos_corr_target_enrichment.pdf", plot, width = 20, height = 25, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_pos_corr_target_enrichment.png", plot, width = 20, height = 25, dpi = 300)
```
...
# Save as csv 
write.csv(test, "../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_sig_neg_corr_target_enrichment.csv")
```
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_sig_neg_corr_target_enrichment.pdf", plot, width = 20, height = 35, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_sig_neg_corr_target_enrichment.png", plot, width = 20, height = 35, dpi = 300)
```
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_sig_neg_corr_target_enrichment.pdf", plot, width = 20, height = 25, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_sig_neg_corr_target_enrichment.png", plot, width = 20, height = 25, dpi = 300)
```
...
# Save as csv 
write.csv(test, "../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_sig_pos_corr_target_enrichment.csv")
```
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_sig_pos_corr_target_enrichment.pdf", plot, width = 20, height = 35, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/topGO_sig_pos_corr_target_enrichment.png", plot, width = 20, height = 35, dpi = 300)
```
...
# Save plot 
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_sig_pos_corr_target_enrichment.pdf", last_plot(), width = 20, height = 25, dpi = 300)
ggsave("../../E-Peve/output/10-Peve-mRNA-miRNA-interactions/top10GO_sig_pos_corr_target_enrichment.png", last_plot(), width = 20, height = 25, dpi = 300)
```
