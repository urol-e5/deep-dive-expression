...
```{r, engine='bash'}
sort ../output/17-Peve-lncRNA/lncRNA_candidates.gtf | uniq -d
```
...
# File paths (local)
fasta_file <- "../output/17-Peve-lncRNA/lncRNA.fasta"
gtf_file <- "../output/17-Peve-lncRNA/lncRNA.gtf"
...
new_headers <- paste0("Peve_", unique_gene_ids)
...
# Write new FASTA
writeXStringSet(fasta, filepath = "../output/17-Peve-lncRNA/lncRNA_renamed.fasta", format = "fasta")
...
```{bash}
head ../output/17-Peve-lncRNA/lncRNA_renamed.fasta
```



```{bash}
cp ../output/17-Peve-lncRNA/lncRNA_renamed.fasta ../output/17-Peve-lncRNA/Peve-lncRNA.fasta

cp ../output/17-Peve-lncRNA/lncRNA.gtf ../output/17-Peve-lncRNA/Peve-lncRNA.gtf

md5sum ../output/17-Peve-lncRNA/Peve-lncRNA.fasta
md5sum ../output/17-Peve-lncRNA/Peve-lncRNA.gtf
```
