...
&> ../output/06-Peve-Hisat/hisat2.log
```

```{r, engine='bash', eval=TRUE}
cat ../output/06-Peve-Hisat/hisat.out
```
...
```{bash}
cp ../output/06-Peve-Hisat/gene_count_matrix.csv ../output/06-Peve-Hisat/Apul-gene_count_matrix.csv
```
