---
title: "30.00-Peve-transcriptome-GOslims"
author: "Sam White"
date: "2025-06-20"
output: 
  github_document:
...
This notebook will perform annotation of expressed genes, as previously determined by [`06-Peve-Hisat.qmd`](https://github.com/urol-e5/deep-dive-expression/blob/7958cd3fdd10f4f80fb499d60e8befa55f3600a7/E-Peve/code/06-Peve-Hisat.qmd) (GitHub).
...
# FILES
count_matrix <- file.path(output_dir, "06-Peve-Hisat/gene_count_matrix.csv")
diamond_db <- "20250620-diamond"
diamond_output <- file.path(output_dir, "30.00-Peve-transcriptome-GOslims", "Pevermanni-expressed-genes.blastx.outfmt6")
genome_fasta <- file.path(data_dir, "Porites_evermanni_v1.fa")
genes_fasta <- file.path(output_dir, "30.00-Peve-transcriptome-GOslims", "Pevermanni-genes.fasta")
genes_fasta_index <- file.path(output_dir, "30.00-Peve-transcriptome-GOslims", "Pevermanni-genes.fasta.fai")
genes_subset_fasta <- file.path(output_dir, "30.00-Peve-transcriptome-GOslims", "Pevermanni-subset-genes.fasta")
genes_subset_fasta_index <- file.path(output_dir, "30.00-Peve-transcriptome-GOslims", "Pevermanni-subset-genes.fasta.fai")
genes_bed <- file.path(output_dir, "30.00-Peve-transcriptome-GOslims", "Pevermanni-genes.bed")
...
uniprot <- read.delim(file.path(output_dir, "uniprot-retrieval.tsv", header = TRUE, stringsAsFactors = FALSE, check.names = FALSE))
