...
```{r}
miRNAs = genomation::gffToGRanges("../output/05-Peve-sRNA-ShortStack_4.1.0/ShortStack_out/known_miRNAs.gff3")
head(miRNAs)
```
...
```{r}
lncRNAs = genomation::gffToGRanges("../output/07-Peve-lncRNA-matrix/Peve-lncRNAs.gtf")
head(lncRNAs)
```
