...
31,501 (all) mRNA significantly correlate (p-val < 0.05) with a total of 10,085 (all) lncRNA, to form a total of 43,290,140 unique pairs with significantly correlated expression. 

Of these, all also had correlation magnitudes of at least 0.5. The vast majority of correlations (41,982,960 or 97.0%) were positive, though some (1,307,180 or 3.0%) were negative.
...
For the significant pairs (|PCC| > 0.5, pval < 0.05), the mRNAs are correlated with 34-3,995 unique lncRNAs, while the lncRNAs are correlated with 263-8,884 unique mRNAs. Generally, mRNA interact with far fewer unique lncRNA (mean = 1,374.25) than do lncRNA with unique mRNA (mean = 4,292.53).
