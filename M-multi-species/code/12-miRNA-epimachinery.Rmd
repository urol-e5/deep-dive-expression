...
machinery. Peve is concentrated in two categories --- ubiquitin
signaling (40%) and ncRNA biogenesis (33%) together account for \~73% of
all hits. Peve has zero RNA-modification, ADP-ribosylation, and
DNA-methylation hits.

Ptuh is ncRNA-dominated, with ncRNA biogenesis & silencing alone
accounting for 44% of hits --- the highest fractional concentration in
any single category across any species.
