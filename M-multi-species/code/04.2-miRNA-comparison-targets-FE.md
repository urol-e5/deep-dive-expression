...
DNMT1, the DNMT responsible for maintaining DNA methylation marks. This
miRNA is one of the few that is almost exclusively *negatively*
...
degradation. It is also partially conserved, matching the P.tuahiniensis
miRNA ptuh-mir-novel-7 (see
...
and Piwi. This miRNA is one of the few that is almost exclusively
...
repression or mRNA degradation. It is not conserved with any other study
species.
...
![](04.2-miRNA-comparison-targets-FE_files/figure-gfm/unnamed-chunk-22-7.png)<!-- -->

``` r
region_pie(Peve_FA_df[sign(Peve_FA_df$PCC.cor) > 0,], "#1E2761")
```

![](04.2-miRNA-comparison-targets-FE_files/figure-gfm/unnamed-chunk-22-8.png)<!-- -->

``` r
region_pie(Ptuh_FA_df[sign(Ptuh_FA_df$PCC.cor) > 0,], "#7A2048")
```

![](04.2-miRNA-comparison-targets-FE_files/figure-gfm/unnamed-chunk-22-9.png)<!-- -->
