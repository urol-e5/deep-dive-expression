...
``` r
stacked_bar_simple(Peve_FA_df, "#408EC6", "P. evermanni", ymin=0 , ymax=250, cons_asterisk=TRUE)
```

![](04.2-miRNA-comparison-targets-FE_files/figure-gfm/unnamed-chunk-23-5.png)<!-- -->

``` r
stacked_bar_simple(Ptuh_FA_df, "#408EC6", "P. tuahiniensis", ymin=0 , ymax=250, cons_asterisk=TRUE)
```
