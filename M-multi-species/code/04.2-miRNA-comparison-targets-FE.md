...
``` r
write.csv(filter(Apul_binding_sum, total_binding_sites>1), "../output/04.2-miRNA-comparison-targets-FE/Apul_multibinding.csv", row.names = FALSE, quote = FALSE)
write.csv(filter(Peve_binding_sum, total_binding_sites>1), "../output/04.2-miRNA-comparison-targets-FE/Peve_multibinding.csv", row.names = FALSE, quote = FALSE)
write.csv(filter(Ptuh_binding_sum, total_binding_sites>1), "../output/04.2-miRNA-comparison-targets-FE/Ptuh_multibinding.csv", row.names = FALSE, quote = FALSE)
```
