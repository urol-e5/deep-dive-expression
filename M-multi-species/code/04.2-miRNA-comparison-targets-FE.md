...
So there IS a significant difference in miRNA proportion of positive
target correlations between the CDS and UTR binding regions
(Kruskal-Wallis, FDR-adjusted p = 2.395488e-08). **CDS regions are
enriched for positively coexpressed targets**, compared to the UTRs.
There is not, however, a difference between the two UTR regions (3UTR v
5 UTR) (Kruskal-Wallis, FDR-adjusted p = 3.184918e-01).
