...
fig1 <- ggplot(mir_props, aes(species, prop_CDS, fill = species)) +
...
fig1_fancy <- ggplot(mir_props, aes(species, prop_CDS, fill = species)) +
  geom_hline(yintercept = 0.5, linetype = "dashed",
             colour = "grey55", linewidth = 0.4) +
  geom_boxplot(width = 0.55, outlier.shape = NA, alpha = 0.55,
               linewidth = 0.4) +
...
``` r
ggsave("../output/04.2-miRNA-comparison-targets-FE/region_distribution_fancy.png", fig1_fancy, width = 4.8, height = 4.6, dpi = 300, bg = "white")
ggsave("../output/04.2-miRNA-comparison-targets-FE/direction_fancy.png", fig2_fancy, width = 4.8, height = 4.6, dpi = 300, bg = "white")
ggsave("../output/04.2-miRNA-comparison-targets-FE/paired_CDS_vs_UTR_fancy.png", fig3_fancy, width = 8.0, height = 4.2, dpi = 300, bg = "white")
```
