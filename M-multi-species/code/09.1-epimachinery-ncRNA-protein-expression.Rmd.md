09.1-epimachinery-ncRNA-protein-expression
================
Kathleen Durkin
2026-04-28

- [Clean up machinery list](#clean-up-machinery-list)
  - [Apul](#apul)
  - [Peve](#peve)
  - [Ptua](#ptua)
...
There are a few instances of single coral genes matching more than one
ncRNA/epimachinery gene. Let’s clean that up before proceeding
...
Also want a single, more “generic” epimachinery name for instances of
multiple matches (e.g., if a gene matches DICER1 and DICER2, assign it
the name DICER)
...
```
    ...
    ## # A tibble: 6 × 4
    ##   Species Protein_ID Protein_of_interest          Protein_of_interest_simplified
    ##   <chr>   <chr>      <chr>                        <chr>                         
    ## 1 Apul    FUN_000213 RDRP                         RDRP                          
    ## 2 Apul    FUN_000641 NFX1                         NFX1                          
    ## 3 Apul    FUN_000894 AEBP2                        AEBP2                         
    ## 4 Apul    FUN_001019 USP47                        USP47                         
    ## 5 Apul    FUN_001086 PPP1R12A; PPP1R12B; PPP1R12C PPP1R12                       
    ## 6 Apul    FUN_001141 KAT6A; KAT6B; KAT7           KAT
...
```
    ...
    ## Warning in geom_col(color = "black", width = 0.7, size = 1.5): Ignoring unknown
    ## parameters: `size`
