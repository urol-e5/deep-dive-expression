...
setwd(".")
if (!dir.exists("miRNA_integration_output")) {
  dir.create("miRNA_integration_output")
}
...
ggsave("miRNA_integration_output/miRNA_expression_distribution.png", 
...
ggsave("miRNA_integration_output/miRNA_expression_heatmap.png", 
...
ggsave("miRNA_integration_output/miRNA_mRNA_interaction_stats.png", 
...
ggsave("miRNA_integration_output/correlation_distribution.png", 
...
ggsave("miRNA_integration_output/top_mirnas_expression.png", 
...
if (nrow(top_network_data) > 0) {
  ...
  write.csv(network_metrics, "miRNA_integration_output/network_metrics.csv", row.names = FALSE)
...
ggsave("miRNA_integration_output/species_comparison.png", 
...
ggsave("miRNA_integration_output/target_analysis.png", 
...
write.csv(summary_df, "miRNA_integration_output/summary_statistics.csv", row.names = FALSE)
...
ggsave("miRNA_integration_output/comprehensive_summary.png", 
...
write.csv(all_miRNA_expression, "miRNA_integration_output/all_miRNA_expression.csv", row.names = FALSE)
write.csv(all_mirna_mrna_interactions, "miRNA_integration_output/all_mirna_mrna_interactions.csv", row.names = FALSE)
write.csv(all_mirna_lncrna_interactions, "miRNA_integration_output/all_mirna_lncrna_interactions.csv", row.names = FALSE)
write.csv(significant_interactions, "miRNA_integration_output/significant_interactions.csv", row.names = FALSE)

cat("Analysis complete! Results saved in 'miRNA_integration_output' directory.\n")
