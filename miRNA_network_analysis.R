...
if (!is.null(apul_plot)) {
  ggsave("miRNA_integration_output/apul_network.png", apul_plot, width = 12, height = 10, dpi = 300)
}
if (!is.null(peve_plot)) {
  ggsave("miRNA_integration_output/peve_network.png", peve_plot, width = 12, height = 10, dpi = 300)
}
if (!is.null(ptuh_plot)) {
  ggsave("miRNA_integration_output/ptuh_network.png", ptuh_plot, width = 12, height = 10, dpi = 300)
}
...
ggsave("miRNA_integration_output/network_comparison.png", comparison_plot, width = 10, height = 6, dpi = 300)
ggsave("miRNA_integration_output/network_density.png", density_plot, width = 10, height = 6, dpi = 300)
...
write.csv(network_comparison, "miRNA_integration_output/network_comparison_metrics.csv", row.names = FALSE)

# Save hub miRNAs
if (!is.null(apul_hubs)) {
  write.csv(apul_hubs, "miRNA_integration_output/apul_hub_mirnas.csv", row.names = FALSE)
}
if (!is.null(peve_hubs)) {
  write.csv(peve_hubs, "miRNA_integration_output/peve_hub_mirnas.csv", row.names = FALSE)
}
if (!is.null(ptuh_hubs)) {
  write.csv(ptuh_hubs, "miRNA_integration_output/ptuh_hub_mirnas.csv", row.names = FALSE)
}
...
if (!is.null(apul_interactive)) {
  write.csv(apul_interactive$nodes, "miRNA_integration_output/apul_interactive_nodes.csv", row.names = FALSE)
  write.csv(apul_interactive$edges, "miRNA_integration_output/apul_interactive_edges.csv", row.names = FALSE)
}
if (!is.null(peve_interactive)) {
  write.csv(peve_interactive$nodes, "miRNA_integration_output/peve_interactive_nodes.csv", row.names = FALSE)
  write.csv(peve_interactive$edges, "miRNA_integration_output/peve_interactive_edges.csv", row.names = FALSE)
}
if (!is.null(ptuh_interactive)) {
  write.csv(ptuh_interactive$nodes, "miRNA_integration_output/ptuh_interactive_nodes.csv", row.names = FALSE)
  write.csv(ptuh_interactive$edges, "miRNA_integration_output/ptuh_interactive_edges.csv", row.names = FALSE)
}
