...
precursor_lncRNA_BLASTn %>% 
  ...
  unique() 
```
We have 34 alignments of a full pre-miRNA to a lncRNA with no mismatches. 31 lncRNA and 23 miRNA are represented.
...
This is a dramatically smaller number -- only 163 interactions are at least 21 nucleotides with <=3 mismatches
