...
### Note: this is pretty odd because Porites and Acropora are in the same clade (complex corals) - worth looking into reasons why the genomes are grouping like this.

## Analyze data:

This is based off of Jill Ashey's script here: https://github.com/JillAshey/SedimentStress/blob/master/RAnalysis/Orthogroups.Rmd
...
### *Step 2*: Expand table to show each gene as a row and the gene ID and orthogroup ID as the 2 columns
...
### *Step 3*: Merge all orthogroups tables for all 3 species into one table that will be used to generate the Upset Plot
...
#### Join using full joins to capture orthogroups that aren't shared. This is more accurate.
```{r}
...
![OrthofinderUpset](../output/20-Apul-Orthofinder/Results_Dec20/upset_ortho.png)
