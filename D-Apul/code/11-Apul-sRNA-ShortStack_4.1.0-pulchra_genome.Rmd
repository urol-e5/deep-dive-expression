...
```{r save-bash-variables-to-rvars-file, engine='bash'}
{
...
```{r rename-genome-filename, engine='bash'}
# Load bash variables into memory
source .bashvars
...
```{r shortstack-synopsis, engine='bash'}
# Load bash variables into memory
source .bashvars
...
Generate separate fastas and gffs for the precursor, star, and mature miRNAs
```{r, engine='bash'}
