...
For the significant pairs, the miRNAs can interact with 4-120 unique lncRNAs, while the lncRNAs can interact with with 1-6 unique miRNAs. For the significant pairs that have high query similarity, the miRNAs can interact with 2-47 unique lncRNAs, while the lncRNAs can interact with 1-4 unique miRNAs. Interesting! 
