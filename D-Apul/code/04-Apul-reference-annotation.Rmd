---
title: "04-Apul-reference-annotation"
...
-out ../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-uniprot_blastx.tab \
-evalue 1E-20 \
-num_threads 20 \
-max_target_seqs 1 \
-outfmt 6
...
echo "First few lines:"
head -2 ../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-uniprot_blastx.tab

echo "Number of lines in output:"
wc -l ../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-uniprot_blastx.tab
```
...
tr '|' '\t' < ../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-uniprot_blastx.tab \
> ../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-uniprot_blastx_sep.tab

head -1 ../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-uniprot_blastx_sep.tab
...
bltabl <- read.csv("../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-uniprot_blastx_sep.tab", sep = '\t', header = FALSE)
...
write.table(annot_tab, file = "../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-IDmapping-2024_08_21.tab", sep = "\t",
            row.names = TRUE, col.names = NA)
```

```{r transcriptome-view-headers, engine='bash'}
head -n 3 ../output/04-Apul-reference-annotation/Apul_GCF_013753865.1_rna-IDmapping-2024_08_21.tab
```
...
png("../output/04-Apul-reference-annotation/GOlegend.png", width = 800, height = 600)
par(mar = c(0, 0, 0, 0))
plot.new()
...
knitr::include_graphics("../output/04-Apul-reference-annotation/GOlegend.png")
```

```{r transcriptome-remove-legend-file, engine='bash', eval=TRUE}
rm ../output/04-Apul-reference-annotation/GOlegend.png
```