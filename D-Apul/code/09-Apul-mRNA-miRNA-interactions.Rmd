...
head(mRNA_counts_filt)
str(mRNA_counts_filt)
```
...
# Save as csv
write.csv(pcc_results, "../../D-Apul/output/09-Apul-mRNA-miRNA-interactions/PCC_miRNA_mRNA.csv")
```
...
write.csv(pairs_of_interest_pcc, "../../D-Apul/output/09-Apul-mRNA-miRNA-interactions/miranda_PCC_sig_miRNA_mRNA.csv")
```
...
```{r}
pairs_of_interest_pcc <- read.csv("../../D-Apul/output/09-Apul-mRNA-miRNA-interactions/miranda_PCC_sig_miRNA_mRNA.csv")
```
