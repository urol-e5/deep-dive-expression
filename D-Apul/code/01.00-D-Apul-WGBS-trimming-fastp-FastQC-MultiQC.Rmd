---
title: "01.00-D-Apul-trimming-fastp-FastQC-MultiQC"
author: "Sam White"
date: "2025-02-07"
output: 
...
FastQs: Expects FastQs formatted like so: `<number>_S<number>_R1_001.fastq.gz`
...
[01.00-D-Apul-trimming-fastp-FastQC-MultiQC/]()
...
echo 'export output_dir_top="${repo_dir}/D-Apul/output/01.00-D-Apul-trimming-fastp-FastQC-MultiQC"'
...
```{bash trimmed-fastqc-multiqc, engine='bash', eval=FALSE}
# Load bash variables into memory
source .bashvars
