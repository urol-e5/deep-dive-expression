...
mRNA_norm <- normalize_counts(gene_counts)
```
...
p <- ggraph(g_tbl, layout = "fr") +
  ...
  scale_color_manual(values = c("miRNA" = "lightblue", "mRNA" = "lightgreen", "blue" = "blue", "red" = "red")) +
  theme_graph() +
...
ggsave("../../D-Apul/output/09-Apul-mRNA-miRNA-interactions/prelim_miRNA_mRNA_network.pdf", p, width = 12, height = 10)
```
