...
- <a href="#3-fe-of-specific-mirnas-targets"
  id="toc-3-fe-of-specific-mirnas-targets">3 FE of specific miRNA’s
  targets</a>
- <a
  href="#4-fe-of-all-targets-negatively-correlated-with-mirnas-regardless-of-correlation-significance"
  id="toc-4-fe-of-all-targets-negatively-correlated-with-mirnas-regardless-of-correlation-significance">4
  ...
  - <a href="#404-join-ontologies" id="toc-404-join-ontologies">4.0.4 Join
    ontologies</a>
- <a
  href="#5-fe-of-all-targets-positively-correlated-with-mirnas-regardless-of-correlation-significance"
  id="toc-5-fe-of-all-targets-positively-correlated-with-mirnas-regardless-of-correlation-significance">5
  ...
  - <a href="#504-join-ontologies" id="toc-504-join-ontologies">5.0.4 Join
    ontologies</a>
- <a
  href="#6-fe-of-all-targets-significantly-negatively-correlated-with-mirnas"
  id="toc-6-fe-of-all-targets-significantly-negatively-correlated-with-mirnas">6
  ...
  - <a href="#604-join-ontologies" id="toc-604-join-ontologies">6.0.4 Join
    ontologies</a>
- <a
  href="#7-fe-of-all-targets-significantly-positively-correlated-with-mirnas"
  id="toc-7-fe-of-all-targets-significantly-positively-correlated-with-mirnas">7
...
# 3 FE of specific miRNA’s targets
...
results <- NULL  # initialize empty df
...
for(miRNA in interacting_miRNAs) {
  ...
  if (nrow(miRNA_results) > 0) {
    ...
    results <- rbind(results, miRNA_results)
  }
}
```
...
``` r
write.csv(results, "../output/09.1-Apul-mRNA-miRNA-interactions-functional-enrichment/miRNA_targets_topGO_FE.csv")
```

# 4 FE of all targets negatively correlated with miRNAs (regardless of correlation significance)
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
# 5 FE of all targets positively correlated with miRNAs (regardless of correlation significance)
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-43-1.png)<!-- -->
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-44-1.png)<!-- -->
...
# 6 FE of all targets significantly negatively correlated with miRNAs
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-58-1.png)<!-- -->
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-59-1.png)<!-- -->
...
# 7 FE of all targets significantly positively correlated with miRNAs
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-73-1.png)<!-- -->
...
![](09.1-Apul-mRNA-miRNA-interactions-functional-enrichment_files/figure-gfm/unnamed-chunk-74-1.png)<!-- -->
