...
wc -l ../output/10.1-Apul-lncRNA/RNA*.gtf
head ../output/10.1-Apul-lncRNA/RNA*.gtf
```
...
wc -l ../output/10.1-Apul-lncRNA/stringtie_merged.gtf
head ../output/10.1-Apul-lncRNA/stringtie_merged.gtf


echo "what is possible"

grep -v '^#' ../output/10.1-Apul-lncRNA/stringtie_merged.gtf | cut -f3 | sort | uniq -c
...
```{r, engine='bash', eval=TRUE}
ls ../output/10.1-Apul-lncRNA/gffcompare_merged*
```

```{r, engine='bash', eval=TRUE}
cat ../output/10.1-Apul-lncRNA/gffcompare_merged.stats
```

```{r, engine='bash', eval=TRUE}
head -10 ../output/10.1-Apul-lncRNA/gffcompare_merged.annotated.gtf
```
...
```{r, engine='bash', eval=TRUE}
wc -l ../output/10.1-Apul-lncRNA/Apul_lncRNA_candidates.gtf
head ../output/10.1-Apul-lncRNA/Apul_lncRNA_candidates.gtf
```
...
```{r, engine='bash', eval=TRUE}
wc -l ../output/10.1-Apul-lncRNA/Apul_CPC2.txt
head ../output/10.1-Apul-lncRNA/Apul_CPC2.txt
```
...
```{r, engine='bash'}
wc -l ../output/10.1-Apul-lncRNA/Apul_noncoding_transcripts_ids.txt
head ../output/10.1-Apul-lncRNA/Apul_noncoding_transcripts_ids.txt
```
...
```{r, engine='bash'}
fgrep -c ">" ../output/10.1-Apul-lncRNA/Apul_lncRNA.fasta
fgrep ">" ../output/10.1-Apul-lncRNA/Apul_lncRNA.fasta | head -5

head ../output/10.1-Apul-lncRNA/Apul_lncRNA.fasta
```
...
```{r, engine='bash', eval=TRUE}
head ../output/10.1-Apul-lncRNA/Apul_lncRNA.bed
```
...
RNA-ACR-140 ../output/10.1-Apul-lncRNA/RNA-ACR-140.gtf RNA-ACR-145 ../output/10.1-Apul-lncRNA/RNA-ACR-145.gtf RNA-ACR-173 ../output/10.1-Apul-lncRNA/RNA-ACR-173.gtf RNA-ACR-178 ../output/10.1-Apul-lncRNA/RNA-ACR-178.gtf

```{r, engine='bash'}
head ../output/10.1-Apul-lncRNA/list01.txt
```

```{r, engine='bash'}
python /home/shared/stringtie-2.2.1.Linux_x86_64/prepDE.py \
-i ../output/10.1-Apul-lncRNA/list01.txt \
-g ../output/10.1-Apul-lncRNA/lnc-gene_count_matrix.csv \
-t ../output/10.1-Apul-lncRNA/lnc-transcript_count_matrix.csv

head ../output/10.1-Apul-lncRNA/*matrix.csv
